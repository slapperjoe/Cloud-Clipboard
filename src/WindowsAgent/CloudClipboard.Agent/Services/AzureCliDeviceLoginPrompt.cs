...
#else
    class AzureCliDeviceLoginPrompt : IAzureCliDeviceLoginPrompt
    {
        public System.Threading.Tasks.Task<bool> PromptAsync(string azExecutablePath, System.Threading.CancellationToken cancellationToken) => System.Threading.Tasks.Task.FromResult(false);
    }
#endif
